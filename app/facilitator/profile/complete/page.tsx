        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={cardStyle}>
            ...
            <div style={{ ...fieldStyle }}>
              ...
              <div style={photoZoneStyle}>
                ...
                <div>
                  ...
                  <p style={photoHintStyle}>JPG or PNG, max 5MB. Square crop works best.</p>
                </div>
              </div>
              <input
                ref={fileInputRef}
            ...
            <div style={fieldStyle}>
              ...
              <textarea
                ...
                required
                placeholder="Tell families a little about yourself — your background, approach, and what you love about working with children…"
                style={textareaStyle}
              />
            </div>
          </div>
          ...
          <div style={cardStyle}>
            ...
            <div style={rowStyle}>
              <div style={fieldStyle}>
                <label style={labelStyle}>
                  WWC number <span style={requiredStyle}>*</span>
                </label>
                <input
                  name="wwc_number"
                  value={form.wwc_number}
                  onChange={handleChange}
                  required
                  placeholder="e.g. WWC0123456"
                  style={inputStyle}
                />
              </div>
              <div style={fieldStyle}>
                <label style={labelStyle}>
                  Expiry date <span style={requiredStyle}>*</span>
                </label>
                <input
                  name="wwc_expiry"
                  type="date"
                  value={form.wwc_expiry}
                  onChange={handleChange}
                  required
                  style={inputStyle}
                />
          ...
          <div style={cardStyle}>
            ...
            <div style={rowStyle}>
              <div style={fieldStyle}>
                <label style={labelStyle}>
                  Insurance provider <span style={requiredStyle}>*</span>
                </label>
                <input
                  ...
                  onChange={handleChange}
                  required
                  placeholder="e.g. Aon, Guild Insurance"
                  style={inputStyle}
                />
              </div>
              <div style={fieldStyle}>
          ...
          <div style={cardStyle}>
            ...
            <div style={rowStyle}>
              <div style={fieldStyle}>
                <label style={labelStyle}>
                  Registration number <span style={requiredStyle}>*</span>
                </label>
                <input
