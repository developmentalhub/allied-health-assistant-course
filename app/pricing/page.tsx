    ...
    <main style={{ minHeight: "100vh", backgroundColor: "#faf8f5", fontFamily: "DM Sans, sans-serif", color: "#1e1b2e" }}>
      ...
      <section style={{ maxWidth: "480px", margin: "0 auto", padding: "0 24px 80px" }}>
        <div style={{ backgroundColor: "white", border: "2px solid #3730a3", borderRadius: "24px", padding: "48px 40px", textAlign: "center", position: "relative" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "14px", marginBottom: "40px", textAlign: "left" }}>
            {[
              ...
              "Content for ages 0–8 across 7 categories",
        ...
        <div style={{ backgroundColor: "#f5f3ff", border: "1px solid #e0e7ff", borderRadius: "16px", padding: "28px 32px", marginTop: "24px", textAlign: "center" }}>
          <p style={{ fontSize: "15px", fontWeight: 600, color: "#3730a3", margin: "0 0 8px" }}>Want to try before you subscribe?</p>
          <p style={{ fontSize: "14px", color: "#6b6880", margin: "0 0 16px", lineHeight: 1.6 }}>
            Watch our free sample videos — no account needed.
          </p>
        ...
        <div style={{ maxWidth: "800px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "48px", alignItems: "center" }}>
          ...
          <div>
            ...
            <p style={{ fontFamily: "var(--font-display)", fontSize: "22px", fontWeight: 300, color: "white", lineHeight: 1.7, margin: "0 0 20px", fontStyle: "italic" }}>
              "I made these videos so that every family — no matter where they live or how busy life is — can access the same support I give families in my clinic."
            </p>
      ...
      <section style={{ maxWidth: "640px", margin: "0 auto", padding: "80px 24px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0" }}>
          {[
            { q: "How many videos are included?", a: "You get access to the full library — all existing videos plus new ones added every month. The library grows over time and your subscription price stays the same." },
            { q: "What age groups are covered?", a: "Content covers ages 0–8 across seven categories: Follow Along Activities, Baby & Tummy Time, Movement & Balance, Hands & Fine Motor, Sensory Play, Speech & Language, and School Readiness." },
            ...
            { q: "Is this the same as Play Move Improve?", a: "Developmental Hub is Robyn's online platform, built from her work at Play Move Improve. The videos bring her clinical expertise directly into your home." },
