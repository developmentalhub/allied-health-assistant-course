      ...
      >
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
            <span style={{ fontSize: "12px", fontWeight: 700, padding: "4px 10px", borderRadius: "6px", backgroundColor: upcoming ? "#eef2ff" : "#f5f3ff", color: upcoming ? "#3730a3" : "#6b6880", textTransform: "uppercase", letterSpacing: "0.05em" }}>
              {session.session_type}
            </span>
            <span style={{ fontSize: "12px", padding: "4px 10px", borderRadius: "6px", backgroundColor: upcoming ? "#f0fdf4" : "#faf8f5", color: upcoming ? "#166534" : "#6b6880", fontWeight: 500 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px", color: "#3730a3", flexShrink: 0 }}>
          <span style={{ fontSize: "13px", fontWeight: 500 }}>
            {upcoming ? "View session" : "View notes"}
          </span>
    ...
    <main style={{ minHeight: "100vh", backgroundColor: "#faf8f5" }}>
      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <p style={{ fontSize: "15px", color: "#6b6880", marginBottom: "40px" }}>
          Click into any session to view bookings and add notes for families.
        </p>
          ...
          {!upcomingSessions || upcomingSessions.length === 0 ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              {upcomingSessions.map((session: any) => (
                <SessionCard key={session.id} session={session} upcoming={true} />
              ))}
            </div>
          )}
        </div>
