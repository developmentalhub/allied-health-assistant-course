      ...
      <section className="mx-auto max-w-4xl px-6 py-14 md:py-20">
        ...
        <section className="rounded-3xl border border-[#e8e4de] bg-white p-8 shadow-sm md:p-12">
          ...
          <h1 className="mb-6 text-4xl font-bold leading-tight md:text-5xl">
            Session booking will be connected later
          </h1>

          <p className="mb-8 text-xl leading-relaxed text-[#5f5b73]">
            This page will later manage academy live session bookings, monthly Zoom access, or replay access when the academy payment and membership structure is final.
          </p>
