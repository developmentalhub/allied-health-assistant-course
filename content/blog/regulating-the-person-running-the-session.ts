...
export const regulatingThePersonRunningTheSession: BlogPost = {
  slug: 'regulating-the-person-running-the-session',

  title:
    'We talk a lot about regulating the client. What about the person running the session?',
  ...
  seoTitle:
    'Emotional Regulation for Allied Health Assistants and Professionals',

  seoDescription:
    'Jess and Robyn explore emotional regulation for Allied Health Assistants and Allied Health Professionals, including co-regulation, sensory load, transitions between sessions and practical ways to reset before seeing the next client.',

  keywords: [
    'emotional regulation allied health',
    'Allied Health Assistant wellbeing',
    'allied health professional wellbeing',
    'co-regulation allied health',
    'AHA emotional regulation',
    'allied health burnout',
    'nervous system regulation allied health',
    'allied health supervision',
    'AHA professional development',
    'therapy session regulation',
  ],
  ...
  body: [
    ...
    {
      type: 'p',
      text: "Then sometimes we finish a really hard session, grab the next file and walk straight into another room two minutes later like our own nervous system wasn't part of any of that.",
    },
    {
      type: 'p',
      text: "It was.",
    ...
    {
      type: 'h2',
      text: 'You bring yourself into the room too',
    },
    ...
    {
      type: 'p',
      text: "We respond to other people's energy.",
    },
    {
      type: 'p',
    ...
    {
      type: 'p',
      text: "We're human. That would be a fairly impossible job description.",
    },
    {
      type: 'p',
    ...
    {
      type: 'h2',
      text: 'Sometimes your volume dial is already up',
    },
    ...
    {
      type: 'p',
      text: "Imagine you're driving. The music is loud. Someone is talking beside you. There are people in the back seat. You're trying to watch the road and then another noise starts.",
    },
    {
      type: 'p',
    ...
    {
      type: 'p',
      text: "A client was distressed. A parent was worried. You were running late. You could not find the equipment. Your phone has messages waiting. Then you're meant to walk into the next room and be completely available to another person.",
    },
    {
      type: 'p',
    ...
    {
      type: 'h2',
      text: 'AHAs can feel pressure to keep going',
    },

    {
      type: 'p',
      text: "This can be especially tricky when you're newer.",
    },
    {
      type: 'p',
      text: "You might feel like taking a minute between sessions means you're being slow.",
    },
    {
      type: 'p',
    ...
    {
      type: 'h2',
      text: 'AHPs are not immune either',
    },
    ...
    {
      type: 'p',
      text: "AHPs can move from clinical work to supervision to family conversations to documentation to another client and then wonder why by four o'clock every small interruption feels enormous.",
    },
    {
      type: 'p',
    ...
    {
      type: 'h2',
      text: 'The reset does not have to be impressive',
    },
    ...
    {
      type: 'p',
      text: "For someone else it might be stepping outside for a minute, stretching, sitting quietly before opening the next file or simply noticing, I'm still really activated from that last session.",
    },
    {
      type: 'p',
    ...
    {
      type: 'h2',
      text: 'Sometimes regulation needs supervision, not another breathing exercise',
    },
    ...
    {
      type: 'h2',
      text: 'Your family sometimes gets what is left over',
    },
    ...
    {
      type: 'h2',
      text: 'A regulated practitioner does not mean a calm practitioner all the time',
    },
    ...
    {
      type: 'p',
      text: "We'd love to hear what actually works in real workplaces. What is your tiny reset between sessions? Or what is one thing your workplace does that makes it easier to arrive at the next client with something left in the tank? Add it below. We have a feeling the simplest ideas might be the ones other people actually use.",
    },
  ],
};